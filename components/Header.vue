    ...
    <div class="relative flex h-22 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <img class="block h-26 w-24 lg:hidden" src="~/assets/Logo.png" alt="Your Company">
          <img class="hidden h-26 w-24 lg:block" src="~/assets/Logo.png" alt="Your Company">
        </div>
        <div class="hidden sm:ml-6 sm:block self-center">
          <div class="flex space-x-4">
            ...
            <div>
              <a href="/chat" class="text-golden-yellow hover:bg-gray-700/50 hover:text-white rounded-md px-5 py-2 text-xl font-medium mr-8">Onirix</a>
            </div>
            <div>
